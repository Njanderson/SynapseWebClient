...
import org.sagebionetworks.web.client.widget.entity.controller.BulkActionControllerView;
import org.sagebionetworks.web.client.widget.entity.controller.BulkActionControllerViewImpl;
...
import org.sagebionetworks.web.client.widget.entity.menu.v2.BulkActionMenuWidgetView;
import org.sagebionetworks.web.client.widget.entity.menu.v2.BulkActionMenuWidgetViewImpl;
...
public class PortalGinModule extends AbstractGinModule {
	...
	protected void configure() {
		...
		bind(BulkActionControllerView.class).to(BulkActionControllerViewImpl.class);
		bind(BulkActionMenuWidgetView.class).to(BulkActionMenuWidgetViewImpl.class);
